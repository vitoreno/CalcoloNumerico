...
% a un'immagine di arrivo con l'interpolazione di Lagrange
clear all
close all
clc
...
% di partenza e 1 per l'immagine di arrivo. L'interpolazione sarà
% effettuata su 100 punti equispaziati tra 0 e 1.
